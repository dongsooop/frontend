...
mixin _$MarketWriteModel {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, title, content, price);

  @override
  String toString() {
    return 'MarketWriteModel(title: $title, content: $content, price: $price)';
  }
}
...
abstract mixin class $MarketWriteModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String content, int price});
}
