...
import 'package:dongsoop/presentation/schedule/common/schedule_text_form.dart';
import 'package:dongsoop/presentation/schedule/util/schedule_date_utils.dart';
import 'package:dongsoop/presentation/schedule/view_models/schedule_delete_view_model.dart';
import 'package:dongsoop/presentation/schedule/view_models/schedule_write_view_model.dart';
import 'package:dongsoop/presentation/schedule/widget/schedule_day_picker.dart';
...
class ScheduleDetailPageScreen extends HookConsumerWidget {
  const ScheduleDetailPageScreen({
    super.key,
    ...
    void showDeleteActionSheet() {
      ...
      customActionSheet(
        ...
        onDelete: () async {
          ...
          try {
            await ref
                .read(scheduleDeleteViewModelProvider.notifier)
