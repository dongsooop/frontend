...
class ScheduleOfficialList extends StatelessWidget {
  const ScheduleOfficialList({
    super.key,
  ...
  final List<ScheduleListEntity> events;
  ...
  Widget build(BuildContext context) {
    final monthEvents = List<ScheduleListEntity>.from(events)
      ..sort((event1, event2) {
