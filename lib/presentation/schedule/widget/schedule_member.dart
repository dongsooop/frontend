...
import 'package:dongsoop/presentation/schedule/widget/schedule_bottom_sheet.dart';
...
class ScheduleMemberView extends StatefulWidget {
  const ScheduleMemberView({
    super.key,
  ...
  final List<ScheduleListEntity> items;
  final VoidCallback onPrevMonth;
  final VoidCallback onNextMonth;
  final Future<bool?> Function(ScheduleListEntity? event, DateTime selectedDate)?
  onTapCalendarDetail;
  final Future<void> Function()? onRefresh;

  @override
  State<ScheduleMemberView> createState() => _ScheduleMemberViewState();
}

class _ScheduleMemberViewState extends State<ScheduleMemberView> {
  ...
  @override
  void didUpdateWidget(covariant ScheduleMemberView oldWidget) {
