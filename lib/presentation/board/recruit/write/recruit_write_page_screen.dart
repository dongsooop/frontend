...
class _RecruitWritePageScreenState
  ...
  void _updateFormValidState() {
    final viewModel = ref.read(recruitWriteViewModelProvider.notifier);
    setState(() {
  ...
  void _handleMajorSelection(List<String> selected) {
    setState(() {
      selectedMajors = selected.contains('전체 학과') ? ['전체 학과'] : selected;
    });
  ...
  void _addTag(String text) {
    ...
    if (trimmed.isNotEmpty &&
        ...
        viewModel.validator.isValidTags([...manualTagList, trimmed])) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    final dateViewModel = ref.read(dateTimeSelectorProvider.notifier);
    ...
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: PrimaryBottomButton(
          ...
          onPressed: () {
            final isStartValid = dateViewModel.validateStartTime();
            final isEndValid = dateViewModel.validateEndTime();
