...
mixin _$SocialState {
  ...
  $SocialStateCopyWith<SocialState> get copyWith =>
      _$SocialStateCopyWithImpl<SocialState>(this as SocialState, _$identity);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, providerType, createdAt);

  @override
  String toString() {
    return 'SocialState(providerType: $providerType, createdAt: $createdAt)';
  }
}
...
abstract mixin class $SocialStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String providerType, DateTime createdAt});
}
